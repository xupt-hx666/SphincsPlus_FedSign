...
def args_parser():
    ...
    parser.add_argument('--use_sphincs', type=bool, default=True, help='是否使用SPHINCS+签名')
    parser.add_argument('--sphincs_security', type=int, default=128, help='SPHINCS+安全级别(128/192/256)')
